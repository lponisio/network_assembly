...
link.assembly <- function(p.interacts, model, nsim, fill){
	...
	##model can be "abundance", "TM" (trait matching), "TM2", "BAR" (Barrior trait matching), "BM2", "DTM" (descrete trait matching), "temp" (temporal overlap), "TMTM2" (the two continuous traits), TMTM2TMD (two continuous traits and descrete trait), "ALL" (all the p matrices), "NULL" (forbidden links, temporal overlap and abundance)
